...
<div class="container text-center">
  	  ...
  	  <h2>Department</h2>
  							<form:form method="POST" action="/Employees/saveDep" modelAttribute="depForm" >
							  		<form:hidden path="id"/>  
							    		<div class="form-control">
							    			<input type="hidden" value="${depForm.id}">
							           			<label style=font-weight:bold>Department</label>
							           		<form:input class="form-control" path="department"  placeholder="Enter Department" required="required"/> 
							           </div>    
